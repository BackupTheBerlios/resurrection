...
#pragma once
#define MOD_VERSION _T("ReSuRReCTioN 1.2 Prefinal 4") //[lama] ModVersion
...
#define	MAX_UP_CLIENTS_ALLOWED	250//Ackronic:diminuito num. max di utenti in upload			// max. clients allowed regardless UPLOAD_CLIENT_DATARATE or any other factors. Don't set this too low, use DATARATE to adjust uploadspeed per client
...
#define BADCLIENTBAN			(thePrefs.GetSivkaAskCount())	
#define BADCLIENTTIME			MIN2MS(thePrefs.GetSivkaTimeCount())
