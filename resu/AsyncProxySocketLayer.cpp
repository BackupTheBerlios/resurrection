...
CAsyncProxySocketLayer::~CAsyncProxySocketLayer()
{
	SAFE_DELETE_ARRAY(m_ProxyData.pProxyHost);
	SAFE_DELETE_ARRAY(m_ProxyData.pProxyUser);
	SAFE_DELETE_ARRAY(m_ProxyData.pProxyPass);
	SAFE_DELETE_ARRAY(m_pProxyPeerHost);
	ClearBuffer();
}
...
{
	SAFE_DELETE_ARRAY(m_pStrBuffer);
